          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-3">
                <Link
                  ...
                  className="flex items-center gap-2 bg-gray-600/50 hover:bg-gray-500/50 border border-gray-600/50 text-gray-100 hover:text-white px-4 py-2 rounded-lg transition-all duration-200 text-sm"
                >
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="bg-gray-600 hover:bg-primary transition-colors p-2 rounded-lg"
              >
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <span className="text-gray-400 block">info@leta-gas.com</span>
            ...
            {/* Newsletter Signup */}
            <div className="mt-6">
              <h4 className="font-medium mb-3 text-gray-100">Stay updated</h4>
              <div className="flex">
                <input
                  type="email"
                  placeholder="Your email"
                  className="bg-gray-600 border border-gray-500 text-white placeholder-gray-300 rounded-l-lg px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-primary"
                />
                <Button className="rounded-l-none rounded-r-lg px-4">Subscribe</Button>
              </div>
            </div>
          </div>
        </div>
